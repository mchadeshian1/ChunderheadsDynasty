...
export function TeamRoster({ team, playerDB, salaryMap, refMap, rosterPositions, mode, irCredits, deadCap }: TeamRosterProps) {
  ...
  const totalSalary = sumSalary(allPlayers, salaryMap, refMap, mode);
  ...
  const committedSalary = sumCommitted(allPlayers, salaryMap, refMap, resigned, cut, amnesty, mode) + deadCapTotal;
